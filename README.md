...
Admin-level database logic handles relationships and business rules
...
Profile:
    ...
    View total earnings (calculated dynamically based on number of trainees assigned according to membership plans):
        30% of Monthly Plans
...
Signup:
Separate Signup for Members and Trainers
Member Signup : Name, Age, Phone, Gender, Password
Trainer Signup : Name, Specialization, Phone, Password


🗄️ SQL Operations Implemented:

SELECT – Fetch member details, workouts, attendance, payments
INSERT – Add members, trainers, attendance, payments, workoutplans
